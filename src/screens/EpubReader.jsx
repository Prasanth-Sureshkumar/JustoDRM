...
//         console.log('Navigation update:', data.location);
//       } else if (data.type === 'navigation_ready') {
//         console.log('Navigation ready, TOC:', data.toc);
//       }
//     } catch (error) {
//       console.log('WebView message (raw):', event.nativeEvent.data);
//     }
...
//                     // Listen for navigation ready
//                     rendition.on('navigation:ready', function() {
...
//                     setTimeout(updateNavigationInfo, 1000);
...
//         setTotalLocations(data.totalPages || 0);
...
//       webViewRef.current.injectJavaScript(`
//         if (window.rendition) {
//           window.rendition.display(pageNumber);
//           setTimeout(function() {
//             if (window.updateNavigationInfo) {
//               window.updateNavigationInfo();
//             }
...
//               Page {currentPage} {totalLocations > 0 ? `of ${totalLocations}` : ''}
//             </Text>
//             {totalLocations > 0 && (
//               <Text style={styles.pageProgress}>
//                 {Math.round((currentPage / totalLocations) * 100)}%
//               </Text>
//             )}
//           </View>
